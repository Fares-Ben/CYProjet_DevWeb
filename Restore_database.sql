...
INSERT INTO users (nom, prenom, date_naissance, fonction, email, password, pseudo, photo, niveau, points, last_connexion, nb_connexions, nb_actions, validated, validation_token, token_expiration, theme_prefere)
VALUES
  ('Martin', 'Jeanettee', '1995-02-10', 'Directeur', 'jean.martin@ecole.fr', '$2b$10$IOq/NB1/UAoIX5Thif8AnuakpeJ/Vkki1Rhn7BcoTvIXN8.2A9Fmq', 'e-jMartine', 'jean.jpg', 'simple', 98, '2025-04-08 00:19:51', 0, 0, 1, NULL, NULL, 'light'),
  ('Lemoine', 'Sophiesss', '2025-04-18', 'Professeur', 'sophie.lemoine@ecole.fr', '$2b$10$/ErDgUDiMtEm.RGlIt4H9.z0IlgZL5KBmF7W8GUyQYlzW6b73YW.m', 'e-sLemoiness', 'sophie.jpg', 'complexe', 4, '2002-04-11 00:00:00', 0, 0, 1, NULL, NULL, 'light'),
  ('Durands', 'Paul', '1994-09-19', 'Directeur', 'paul.durand@ecole.fr', '$2b$10$ZtxXldgd6erirxQOLr5LbeVQ.WkGt1h6CLjf36uD4xq0xjxNHMGIK', 'e-pDurand', 'paul.jpg', 'admin', 6, '2025-04-09 16:33:53', 0, 0, 1, NULL, NULL, 'light'),
  ('Moreau', 'Emma', '2016-09-04', 'Eleve', 'emma.moreau@ecole.fr', '$2b$10$p/Ox8UnD42WQg64Zwwa9cONLUoeSKoTJybWDDPVz8gyQC66P8PZMK', 'e-eMoreau', 'emma.jpg', 'admin', 3, NULL, 0, 0, 1, NULL, NULL, 'light'),
  ('Petit', 'Léo', '2017-05-28', 'Personnel', 'leo.petit@ecole.fr', '$2b$10$Agq2CuL4FC5.MZYqWly1Qeh1OhOd2r/hgGytfGFodFC718iH.wmaa', 'e-lPetit', 'leo.jpg', 'simple', 0, '2025-04-09 14:49:43', 0, 0, 1, NULL, NULL, 'light');
